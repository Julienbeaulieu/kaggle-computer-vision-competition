...
class TrainMixin:
    def train(self, cfg: CfgNode):
        ...
        self.loader_train = build_data_loader(data_train, cfg.DATASET, True)
        self.loader_val = build_data_loader(data_val, cfg.DATASET, False)
        ...
        optimizer = build_optimizer(self.model, solver_cfg)
